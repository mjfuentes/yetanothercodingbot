...
Phase 8: Usage API integration for actual usage tracking
"""
...
class CostTracker:
    ...
    def sync_with_usage_api(self) -> tuple[bool, str]:
        """
        Sync local usage tracking with actual usage from Anthropic Usage API
